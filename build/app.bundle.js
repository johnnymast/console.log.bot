...
var Bot = function () {
    ...
    (0, _createClass3.default)(Bot, [{
        ...
        value: function printMenu() {
            var lines = ["Are you looking for a job?", " 1) Yes... and I'm the ninja unicorn you are looking for", "", "Nope, I was...", " 2) ... just curious", " 3) ... trying to hack into your system", "---", "Try cyberdelia.menu(option)"];
            console.log(lines.join("\n"));
        }
    }, {
        key: "knock",
        value: function knock() {
            console.log('Hi cyber-space traveller. Maybe you want to see our bot.menu().');
        }
    }, {
        key: "menu",
        value: function menu(opt) {
